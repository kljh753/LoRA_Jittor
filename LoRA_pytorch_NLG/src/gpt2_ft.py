...
def train_validate(
    ...
    if args.platform != 'single' and hasattr(train_loader.sampler, 'set_epoch'):
...
if __name__ == '__main__':
    ...
    # Configure DataLoader based on platform parameter
    ...
    # Fix: Use args.device instead of hardcoded cuda()
